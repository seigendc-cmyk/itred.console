...
export const INITIAL_PLANS: Plan[] = [
  ...
  },
  {
    ...
    interval: 'Monthly',
    activeVendors: 42,
    enabledApps: ['Core POS', 'Advanced CRM', 'Multi-Store Sync', 'Reporting Logs'],
    maxBranches: '5',
    maxTerminals: '10',
    maxStaff: '30',
    maxProducts: '10,000',
  ...
  {
    id: 'PLN-POS-BUSPLUS',
    name: 'Business Plus POS',
    type: 'Hybrid',
    price: 299,
    interval: 'Monthly',
    activeVendors: 18,
    enabledApps: ['Full POS Suite', 'Multi-Store Sync', 'Warehouse Sync', 'Dedicated API Gateway'],
    maxBranches: '10',
    maxTerminals: '20',
    maxStaff: '50',
    maxProducts: '25,000',
